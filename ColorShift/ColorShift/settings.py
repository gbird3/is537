"""
Django settings for ColorShift project.
...
SECRET_KEY = 'p=)w+lewc=@0r0u5pl6*ow*35ax@8krw)#d($r69^qwugfr2x2'
...
WSGI_APPLICATION = 'ColorShift.wsgi.application'
